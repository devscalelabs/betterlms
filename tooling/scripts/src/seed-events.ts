...
const futureEvents = [
	{
		...
		description:
			"Join us for the biggest React conference of the year with talks from industry experts, workshops, and networking opportunities.",
	...
	},
	{
		...
		description:
			"Monthly JavaScript meetup featuring talks on modern JS frameworks, best practices, and community projects.",
	...
	},
	{
		...
		description:
			"Hands-on workshop covering TypeScript fundamentals, types, interfaces, and practical applications in real-world projects.",
		type: "ONLINE" as const,
		daysAhead: 14,
...
const pastEvents = [
	{
		...
		description:
			"Annual summit dedicated to Node.js ecosystem, featuring talks on performance, scalability, and the latest updates.",
		type: "ONLINE" as const,
		daysAgo: 5,
	...
	},
	{
		...
		description:
			"Explore the intersection of frontend development and DevOps practices. Learn about CI/CD, deployment strategies, and modern tooling.",
		type: "OFFLINE" as const,
		daysAgo: 12,
		url: null,
		city: "New York",
